...
import os from "os";
import fs from "fs";
export async function getGo(versionSpec, checkLatest, auth) {
...
export async function extractGoArchive(archivePath) {
...
export async function getInfoFromManifest(versionSpec, stable, auth) {
    let info = null;
...
export async function findMatch(versionSpec) {
...
export async function getVersionsDist(dlUrl) {
...
export function makeSemver(version) {
...
export function parseGoVersionFile(versionFilePath) {
